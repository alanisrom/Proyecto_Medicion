...
```{r}
  ggplot(
    ...
    scale_y_continuous(limits = c(0, 0.9)) + 
    labs(
      title = "Porcentaje de pobreza comunal y apoyo al A favor 2022",
      x = "Porcentaje de pobreza",
      y = "Porcentaje A favor 2023",
      caption = "Fuente: Servicio Electoral de Chile (SERVEL), Resultados electorales históricos.\nInstituto Nacional de Estadísticas (INE), Resultados CENSO 2024.\nElaboración propia."
    ) +
...
#5.gráfico "Distribución del apoyo al apruebo 2022 agrupando número de municipios según bloque ideológico al que pertenece el alcalde por comunas"
...
#Arovechamos hacerlo también con la variable para A favor
